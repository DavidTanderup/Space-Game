...
namespace Ships
{
    class SpaceShip
    {
        ...
        //Fuel
        public Fuel Fuel1 = new Fuel("-MiniGulp", "0",500 ,2000, 500);
        public Fuel Fuel2 = new Fuel("-MidGulp", "00",1000 ,3500, 1000);
        public Fuel Fuel3 = new Fuel("-BigGulp", "000", 2000 ,5000, 2000);
        //Cargo
        public Cargo Cargo1 = new Cargo("-spacebay", "||", 1000, 0);
        public Cargo Cargo2 = new Cargo("-spaceBAY", "|||", 2000, 0);
        public Cargo Cargo3 = new Cargo("-spaceBAE", "||||", 3000, 0);
